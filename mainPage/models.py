    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['nombre'], name='unique_foraneas_Facultad'),
        ]
        db_table = 'Facultad'
...
class Union_U_F(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['univeridad', 'facultad'], name='unique_foraneas_union')
        ]

    def __str__(self):
        fila = "Universidad: "+str(self.univeridad) + \
            " / Facultad: "+str(self.facultad)
        return fila
...
class Fundacion(models.Model):
    ...
    tipo = models.CharField(
        max_length=20, choices=OPCIONES_TIPO, default=Universidad)
...
class Beca (models.Model):
    ...
    nombre = models.CharField(max_length=50)
    tipo = models.CharField(
        max_length=10, choices=OPCIONES_TIPO, default=Nacional)
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['nombre'], name='unique_foraneas_Beca'),
        ]
        db_table = 'Beca'
...
class Configuracion_Becas(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['Union_U_F', 'Beca', 'Fundacion'], name='unique_foraneas_configuracion')
        ]

    def __str__(self):
        fila = "Union : "+str(self.Union_U_F.univeridad)+"-"+str(self.Union_U_F.facultad) + \
...
class Facultad_fav(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['Facultad', 'Estudiante'], name='unique_foraneas_favoritos_Facultad'),
        ]
...
class Universidad_fav(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['Universidad', 'Estudiante'], name='unique_foraneas_favoritos_Universidad'),
        ]
