...
urlpatterns = [
    ...
    path('Derecho/', views.Derecho),
    path('Arquitectura/', views.Arquitectura),
    path('Enfermeria/', views.Enefermeria),
    path('Gastronomia/', views.Gastronomia),
    path('IngSistemas/', views.IngSistemas),
    path('faq/', views.faq),
